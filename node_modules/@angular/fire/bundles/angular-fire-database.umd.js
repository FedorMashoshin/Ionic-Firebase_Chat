(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('firebase/database'), require('@angular/fire/auth'), require('firebase/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/database', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', 'firebase/database', '@angular/fire/auth', 'firebase/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.database = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, null, global.angular.fire.auth, global.firebase));
}(this, (function (ɵngcc0,exports, i0, rxjs, operators, i1, database, i2, firebase) { 'use strict';
    ...
    ***************************************************************************** */
            ...
            valueChanges: function (events, options) {
                 ...
                 */ a) {
                    ...
                    if (options && options.idField) {
                        return Object.assign(Object.assign({}, ( /** @type {?} */(a.payload.val()))), (_a = {},
    ...
    var AngularFireDatabase = /** @class */ (function () {
        ...
        useAuthEmulator) {
            ...
            this.database = i1.ɵfetchInstance(app.name + ".database." + databaseURL, 'AngularFireDatabase', app, ( /**
             * @return {?}
             */function () {
                /** @type {?} */
                var database = zone.runOutsideAngular(( /**
                 * @return {?}
                 */function () { return app.database(databaseURL || undefined); }));
                if (useEmulator) {
                    database.useEmulator.apply(database, __spread(useEmulator));
                }
                return database;
            }), [useEmulator]);
        }
        ...
        AngularFireDatabase.prototype.list = function (pathOrRef, queryFn) {
            var _this = this;
            /** @type {?} */
            var ref = this.schedulers.ngZone.runOutsideAngular(( /**
             * @return {?}
             */function () { return getRef(_this.database, pathOrRef); }));
            /** @type {?} */
            var query = ref;
            if (queryFn) {
                query = queryFn(ref);
        ...
        AngularFireDatabase.prototype.createPushId = function () {
            ...
            var ref = this.schedulers.ngZone.runOutsideAngular(( /**
             * @return {?}
             */function () { return _this.database.ref(); }));
            return ref.push().key;
        };
AngularFireDatabase.ɵfac = function AngularFireDatabase_Factory(t) { return new (t || AngularFireDatabase)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(URL, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(USE_EMULATOR, 8), ɵngcc0.ɵɵinject(i2.USE_EMULATOR, 8)); };
...
AngularFireDatabaseModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [AngularFireDatabase] });
