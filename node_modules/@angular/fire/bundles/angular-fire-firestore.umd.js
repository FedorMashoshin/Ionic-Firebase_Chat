(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/common'), require('firebase/app'), require('firebase/firestore'), require('@angular/fire/auth')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/firestore', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/common', 'firebase/app', 'firebase/firestore', '@angular/fire/auth'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.firestore = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common, global.firebase, null, global.angular.fire.auth));
}(this, (function (ɵngcc0,exports, i0, rxjs, operators, i1, common, firebase, firestore, i2) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function fromDocRef(ref, scheduler) {
        return fromRef(ref, scheduler)
            .pipe(operators.startWith(undefined), operators.pairwise(), operators.map(( /**
     * @param {?} __0
     * @return {?}
     */function (_a) {
     ...
     */function (_a) {
             ...
             * @param {?} change
             * @return {?}
             */ change) { return ({ type: change.type, payload: change }); }));
            ...
            if (priorAction && JSON.stringify(priorAction.payload.metadata) !== JSON.stringify(action.payload.metadata)) {
                 ...
                 */function (currentDoc, currentIndex) {
                     ...
                     * @param {?} d
                     * @return {?}
                     */ d) { return d.doc.ref.isEqual(currentDoc.ref); }));
                    /** @type {?} */
                     ...
                     * @param {?} d
                     * @return {?}
                     */ d) { return d.ref.isEqual(currentDoc.ref); }));
     ...
     * @param {?} changes
     * @return {?}
     */function (current, changes) { return combineChanges(current, changes.map(( /**
         * @param {?} it
         * @return {?}
         */function (/**
         * @param {?} it
         * @return {?}
         */ it) { return it.payload; })), events); }), []), operators.distinctUntilChanged(), // cut down on unneed change cycles
        operators.map(( /**
         * @param {?} changes
         * @return {?}
         */function (/**
    ...
    function sliceAndSplice(original, start, deleteCount) {
        ...
        returnArray.splice.apply(returnArray, __spread([start, deleteCount], args));
        return returnArray;
    }
    /**
    ...
    var AngularFirestoreCollection = /** @class */ (function () {
        ...
        AngularFirestoreCollection.prototype.stateChanges = function (events) {
            ...
            if (events && events.length > 0) {
                source = source.pipe(operators.map(( /**
                 * @param {?} actions
                 * @return {?}
                 */function (/**
                 * @param {?} actions
                 ...
                 * @param {?} change
                 * @return {?}
                 */ change) { return events.indexOf(change.type) > -1; })); })));
            }
            return source.pipe(
            // We want to filter out empty arrays, but always emit at first, so the developer knows
            // that the collection has been resolve; even if it's empty
            operators.startWith(undefined), operators.pairwise(), operators.filter(( /**
             * @param {?} __0
             * @return {?}
             */function (_a) {
    ...
    var AngularFirestoreDocument = /** @class */ (function () {
        ...
        AngularFirestoreDocument.prototype.collection = function (path, queryFn) {
            /** @type {?} */
            var collectionRef = ( /** @type {?} */(this.ref.collection(path)));
        ...
        AngularFirestoreDocument.prototype.valueChanges = function (options) {
             ...
             */function (_a) {
                ...
                return options.idField ? ( /** @type {?} */(Object.assign(Object.assign({}, payload.data()), (_b = {}, _b[options.idField] = payload.id, _b)))) : payload.data();
            })));
        };
        /**
    ...
    var AngularFirestoreCollectionGroup = /** @class */ (function () {
         ...
         */ actions) { return actions.payload.docs.map(( /**
             ...
             */ a) {
                var _a;
                if (options.idField) {
                    return ( /** @type {?} */(Object.assign((_a = {}, _a[options.idField] = a.id, _a), a.data())));
                }
                else {
                    return a.data();
                }
    ...
    var AngularFirestore = /** @class */ (function () {
        ...
        platformId, zone, persistenceSettings, _useEmulator, useAuthEmulator) {
            ...
            if (!firebase__default['default'].auth && useAuthEmulator) {
                i1.ɵlogAuthEmulatorError();
            }
            /** @type {?} */
            var useEmulator = _useEmulator;
            _a = __read(i1.ɵfetchInstance(app.name + ".firestore", 'AngularFirestore', app, ( /**
             * @return {?}
             */function () {
                /** @type {?} */
                var firestore = zone.runOutsideAngular(( /**
                 * @return {?}
                 */function () { return app.firestore(); }));
                if (settings) {
                    firestore.settings(settings);
                }
                if (useEmulator) {
                    firestore.useEmulator.apply(firestore, __spread(useEmulator));
                }
                if (shouldEnablePersistence && !common.isPlatformServer(platformId)) {
                     ...
                     */function () {
                        try {
                            return rxjs.from(firestore.enablePersistence(persistenceSettings || undefined).then(( /**
                             * @return {?}
        ...
        AngularFirestore.prototype.collectionGroup = function (collectionId, queryGroupFn) {
             ...
             */ ref) { return ref; }));
            /** @type {?} */
            var collectionGroup = ( /** @type {?} */(this.firestore.collectionGroup(collectionId)));
...
AngularFirestore.ɵfac = function AngularFirestore_Factory(t) { return new (t || AngularFirestore)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(ENABLE_PERSISTENCE, 8), ɵngcc0.ɵɵinject(SETTINGS, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(PERSISTENCE_SETTINGS, 8), ɵngcc0.ɵɵinject(USE_EMULATOR, 8), ɵngcc0.ɵɵinject(i2.USE_EMULATOR, 8)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularFirestore, [{
        ...
        args: [{
                ...
                type: i0.Inject,
                args: [i1.FIREBASE_OPTIONS]
            }] }, { type: undefined, decorators: [{
                type: i0.Optional
            }, {
                type: i0.Inject,
                args: [i1.FIREBASE_APP_NAME]
            }] }, { type: undefined, decorators: [{
                type: i0.Optional
            }, {
                type: i0.Inject,
    ...
    AngularFirestore.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [i2.USE_EMULATOR,] }] }
    ]; };
