(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('firebase/functions'), require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/functions', ['@angular/core','exports', 'firebase/functions', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.functions = {}), null, global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire));
}(this, (function (ɵngcc0,exports, functions, i0, rxjs, operators, i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    /** @type {?} */
    var NEW_ORIGIN_BEHAVIOR = new i0.InjectionToken('angularfire2.functions.new-origin-behavior');
    /** @type {?} */
    ...
    var AngularFireFunctions = /** @class */ (function () {
        ...
        function AngularFireFunctions(options, nameOrConfig, zone, region, origin, newOriginBehavior, _useEmulator) {
             ...
             * @param {?} app
             * @return {?}
             */ app) { return i1.ɵfetchInstance(app.name + ".functions." + (region || origin), 'AngularFireFunctions', app, ( /**
             * @return {?}
             */function () {
                /** @type {?} */
                var functions;
                ...
                if (useEmulator) {
                    functions.useEmulator.apply(functions, __spread(useEmulator));
                }
                return functions;
             ...
             * @param {?} functions
             * @return {?}
             */ functions) { return functions.httpsCallable(name, options)(data); })), operators.map(( /**
             * @param {?} r
             * @return {?}
             */function (/**
             * @param {?} r
...
AngularFireFunctions.ɵfac = function AngularFireFunctions_Factory(t) { return new (t || AngularFireFunctions)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(REGION, 8), ɵngcc0.ɵɵinject(ORIGIN, 8), ɵngcc0.ɵɵinject(NEW_ORIGIN_BEHAVIOR, 8), ɵngcc0.ɵɵinject(USE_EMULATOR, 8)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularFireFunctions, [{
    ...
    AngularFireFunctions.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [NEW_ORIGIN_BEHAVIOR,] }] },
...
AngularFireFunctionsModule.ɵfac = function AngularFireFunctionsModule_Factory(t) { return new (t || AngularFireFunctionsModule)(); };
AngularFireFunctionsModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AngularFireFunctionsModule });
AngularFireFunctionsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [AngularFireFunctions] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularFireFunctionsModule, [{
        type: i0.NgModule,
        args: [{
    ...
    exports.NEW_ORIGIN_BEHAVIOR = NEW_ORIGIN_BEHAVIOR;
