(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/common'), require('firebase/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/remote-config', ['@angular/core','exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/common', 'firebase/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire['remote-config'] = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common, global.firebase));
}(this, (function (ɵngcc0,exports, i0, rxjs, operators, i1, common, firebase) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireRemoteConfig = /** @class */ (function () {
        ...
        platformId) {
             ...
             * @return {?}
             */function () { return common.isPlatformBrowser(platformId) ? rxjs.of(undefined) : rxjs.EMPTY; })), operators.switchMap(( /**
             * @return {?}
             ...
             * @param {?} app
             * @return {?}
             */ app) { return i1.ɵfetchInstance(app.name + ".remote-config", 'AngularFireRemoteConfig', app, ( /**
             * @return {?}
             */function () {
                /** @type {?} */
...
AngularFireRemoteConfig.ɵfac = function AngularFireRemoteConfig_Factory(t) { return new (t || AngularFireRemoteConfig)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(SETTINGS, 8), ɵngcc0.ɵɵinject(DEFAULTS, 8), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(i0.PLATFORM_ID)); };
...
AngularFireRemoteConfigModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [AngularFireRemoteConfig] });
