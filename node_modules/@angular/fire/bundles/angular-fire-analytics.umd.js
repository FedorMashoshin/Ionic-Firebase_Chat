(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/fire'),require('@angular/fire/auth'),require('@angular/router'),require('@angular/platform-browser'),exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('rxjs/operators'), require('@angular/fire'), require('@angular/router'), require('@angular/platform-browser'), require('@angular/fire/auth')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/analytics', ['@angular/core','@angular/fire','@angular/fire/auth','@angular/router','@angular/platform-browser','exports', '@angular/core', 'rxjs', '@angular/common', 'rxjs/operators', '@angular/fire', '@angular/router', '@angular/platform-browser', '@angular/fire/auth'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.fire,global.ng.fire.auth,global.ng.router,global.ng.platformBrowser,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.analytics = {}), global.ng.core, global.rxjs, global.ng.common, global.rxjs.operators, global.angular.fire, global.ng.router, global.ng.platformBrowser, global.angular.fire.auth));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, i0, rxjs, common, operators, i1, router, platformBrowser, auth) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireAnalytics = /** @class */ (function () {
        ...
        platformId, zone) {
                ...
                if (firebaseAnalyticsAlreadyInitialized) {
                     ...
                     */ resolve) {
                         ...
                         */function () {
                            ...
                            if (parseMeasurementId_1.apply(void 0, __spread(args))) {
                                resolve();
                            }
                        }));
                    }));
            ...
            /** @type {?} */
            var analytics = rxjs.of(undefined).pipe(operators.observeOn(new i1.ɵAngularFireSchedulers(zone).outsideAngular), operators.switchMap(( /**
             * @return {?}
             */function () { return common.isPlatformBrowser(platformId) ? zone.runOutsideAngular(( /**
             * @return {?}
             */function () { return rxjs.of(undefined); })) : rxjs.EMPTY; })), 
             ...
             * @return {?}
             */function () {
                return i1.ɵfetchInstance("analytics", 'AngularFireAnalytics', app, ( /**
                 * @return {?}
                 */function () {
                    /** @type {?} */
...
AngularFireAnalytics.ɵfac = function AngularFireAnalytics_Factory(t) { return new (t || AngularFireAnalytics)(ɵngcc0.ɵɵinject(ɵngcc1.FirebaseApp), ɵngcc0.ɵɵinject(COLLECTION_ENABLED, 8), ɵngcc0.ɵɵinject(APP_VERSION, 8), ɵngcc0.ɵɵinject(APP_NAME, 8), ɵngcc0.ɵɵinject(DEBUG_MODE, 8), ɵngcc0.ɵɵinject(CONFIG, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
    ...
    var UserTrackingService = /** @class */ (function () {
        ...
        platformId, auth, zone) {
            ...
            if (!common.isPlatformServer(platformId)) {
                 ...
                 * @param {?} resolve
                 * @return {?}
                 */ resolve) { return resolveInitialized_1 = resolve; })); }));
                this.disposables = [
        ...
        UserTrackingService.prototype.ngOnDestroy = function () {
             ...
             * @param {?} it
             * @return {?}
             */ it) { return it.unsubscribe(); }));
        };
UserTrackingService.ɵfac = function UserTrackingService_Factory(t) { return new (t || UserTrackingService)(ɵngcc0.ɵɵinject(AngularFireAnalytics), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc2.AngularFireAuth), ɵngcc0.ɵɵinject(ɵngcc0.NgZone)); };
    ...
    var ScreenTrackingService = /** @class */ (function () {
        ...
        platformId, zone, userTrackingService) {
             ...
             */function () {
                ...
                _this.disposable = activationEndEvents.pipe(operators.switchMap(( /**
                 * @param {?} activationEnd
                 * @return {?}
                 */function (/**
                 * @param {?} activationEnd
                 ...
                 */ activationEnd) {
                    ...
                    /** @type {?} */
                    var urlTree = router$1.parseUrl(router$1.url.replace(/(?:\().+(?:\))/g, ( /**
                     * @param {?} a
                     * @return {?}
                     */function (/**
                     * @param {?} a
                    ...
                    /** @type {?} */
                    var actualSnapshot = router$1.routerState.root.children.map(( /**
                     * @param {?} it
                     * @return {?}
                     */function (/**
                     * @param {?} it
                     ...
                     * @param {?} it
                     * @return {?}
                     */ it) { return it.outlet === activationEnd.snapshot.outlet; }));
                    if (!actualSnapshot) {
                        return rxjs.of(null);
                    }
                    /** @type {?} */
                    ...
                    /** @type {?} */
                    var screenName = actualDeep.pathFromRoot.map(( /**
                     * @param {?} s
                     * @return {?}
                     */function (/**
                     * @param {?} s
                 ...
                 * @param {?} it
                 * @return {?}
                 */ it) { return it[OUTLET_KEY]; })), operators.mergeMap(( /**
                 * @param {?} it
                 * @return {?}
                 */function (/**
                 * @param {?} it
                 * @return {?}
                 */ it) { return it.pipe(operators.distinctUntilChanged(( /**
                 * @param {?} a
                 * @param {?} b
                 * @return {?}
                 */function (a, b) { return JSON.stringify(a) === JSON.stringify(b); })), operators.startWith(undefined), operators.pairwise(), operators.map(( /**
                 * @param {?} __0
                 * @return {?}
                 */function (_b) {
                    var _c;
...
ScreenTrackingService.ɵfac = function ScreenTrackingService_Factory(t) { return new (t || ScreenTrackingService)(ɵngcc0.ɵɵinject(AngularFireAnalytics), ɵngcc0.ɵɵinject(ɵngcc3.Router, 8), ɵngcc0.ɵɵinject(ɵngcc4.Title, 8), ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(UserTrackingService, 8)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ScreenTrackingService, [{
        type: i0.Injectable
    }], function () { return [{ type: AngularFireAnalytics }, { type: ɵngcc3.Router, decorators: [{
                type: i0.Optional
            }] }, { type: ɵngcc4.Title, decorators: [{
                type: i0.Optional
...
AngularFireAnalyticsModule.ɵfac = function AngularFireAnalyticsModule_Factory(t) { return new (t || AngularFireAnalyticsModule)(ɵngcc0.ɵɵinject(AngularFireAnalytics), ɵngcc0.ɵɵinject(ScreenTrackingService, 8), ɵngcc0.ɵɵinject(UserTrackingService, 8)); };
AngularFireAnalyticsModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AngularFireAnalyticsModule });
AngularFireAnalyticsModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [AngularFireAnalytics] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularFireAnalyticsModule, [{
        type: i0.NgModule,
        args: [{
