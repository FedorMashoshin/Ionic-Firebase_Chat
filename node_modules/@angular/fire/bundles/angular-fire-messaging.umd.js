(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('firebase/app'), require('rxjs'), require('rxjs/operators'), require('@angular/fire'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@angular/fire/messaging', ['@angular/core','exports', '@angular/core', 'firebase/app', 'rxjs', 'rxjs/operators', '@angular/fire', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = global.angular.fire || {}, global.angular.fire.messaging = {}), global.ng.core, global.firebase, global.rxjs, global.rxjs.operators, global.angular.fire, global.ng.common));
}(this, (function (ɵngcc0,exports, i0, firebase, rxjs, operators, i1, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AngularFireMessaging = /** @class */ (function () {
        ...
        platformId, zone, vapidKey, _serviceWorker) {
             ...
             * @return {?}
             */function () { return common.isPlatformServer(platformId) ? rxjs.EMPTY : rxjs.of(undefined); })), operators.map(( /**
             * @return {?}
             */function () { return i1.ɵfirebaseAppFactory(options, zone, nameOrConfig); })), operators.switchMap(( /**
             * @param {?} app
             * @return {?}
             */function (/**
             * @param {?} app
             * @return {?}
             */ app) { return i1.ɵfetchInstance(app.name + ".messaging", 'AngularFireMessaging', app, ( /**
             * @return {?}
             ...
             * @param {?} messaging
             * @return {?}
             */function (messaging) { return __awaiter(_this, void 0, void 0, function () {
            ...
            /** @type {?} */
            var notificationPermission$ = new rxjs.Observable(( /**
             * @param {?} emitter
             * @return {?}
             */function (/**
             * @param {?} emitter
             ...
             * @return {?}
             */function () { return firebase__default['default'].messaging.isSupported() ? rxjs.concat(_this.getToken, tokenChange$) : rxjs.EMPTY; })));
            ...
            this.requestToken = rxjs.of(undefined).pipe(operators.subscribeOn(schedulers.outsideAngular), operators.observeOn(schedulers.insideAngular), operators.switchMap(( /**
             * @return {?}
             ...
             * @param {?} messaging
             * @return {?}
             */ messaging) { return messaging.deleteToken(token || undefined); })), operators.defaultIfEmpty(false)); });
            return i1.ɵlazySDKProxy(this, messaging, zone);
        }
AngularFireMessaging.ɵfac = function AngularFireMessaging_Factory(t) { return new (t || AngularFireMessaging)(ɵngcc0.ɵɵinject(i1.FIREBASE_OPTIONS), ɵngcc0.ɵɵinject(i1.FIREBASE_APP_NAME, 8), ɵngcc0.ɵɵinject(i0.PLATFORM_ID), ɵngcc0.ɵɵinject(ɵngcc0.NgZone), ɵngcc0.ɵɵinject(VAPID_KEY, 8), ɵngcc0.ɵɵinject(SERVICE_WORKER, 8)); };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(AngularFireMessaging, [{
    ...
    AngularFireMessaging.ctorParameters = function () { return [
        ...
        { type: i0.NgZone },
        { type: undefined, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: [VAPID_KEY,] }] },
...
AngularFireMessagingModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [AngularFireMessaging] });
