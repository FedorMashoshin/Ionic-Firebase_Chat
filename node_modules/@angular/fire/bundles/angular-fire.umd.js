(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('firebase/app')) :
    typeof define === 'function' && define.amd ? define('@angular/fire', ['@angular/core','exports', 'rxjs', 'rxjs/operators', '@angular/core', 'firebase/app'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,(global.angular = global.angular || {}, global.angular.fire = {}), global.rxjs, global.rxjs.operators, global.ng, global.firebase));
}(this, (function (ɵngcc0,exports, rxjs, operators, core, firebase) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     * @param {?=} options
     * @return {?}
     */function (klass, observable, zone, options) {
             ...
             */function () {
                 ...
                 */function () { }), {
                     ...
                     */ it) {
                        var _a;
                        /** @type {?} */
                        var res = it && it.apply(void 0, __spread(args));
     ...
     */function (level) {
        ...
        if (core.isDevMode() && typeof console !== 'undefined') {
            console[level].apply(console, __spread(args));
        }
    });
    var ɵ0 = log;
    ...
    function ɵfetchInstance(cacheKey, moduleName, app, fn, args) {
        ...
        if (instance) {
            ...
            /** @type {?} */
            var newInstance = fn();
            globalThis.ɵAngularfireInstanceCache.set(cacheKey, __spread([newInstance], args));
            return newInstance;
        }
    }
    /** @type {?} */
...
AngularFireModule.ɵfac = function AngularFireModule_Factory(t) { return new (t || AngularFireModule)(ɵngcc0.ɵɵinject(core.PLATFORM_ID)); };
AngularFireModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: AngularFireModule });
AngularFireModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ providers: [FIREBASE_APP_PROVIDER] });
